...
/**
 * Liste des groupes d'amis (Android). Permet de sélectionner le groupe actif (qui débloque
 * campagnes/fiches/références), d'en créer un et d'ouvrir le détail. Un bouton donne accès aux
 * invitations reçues (pas de top-bar mobile, la nav principale est la bottom bar).
 */
@Composable
fun GroupListPage(
