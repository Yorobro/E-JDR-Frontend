 ...
 *
 * Le jitter est **injecté** ([jitter], défaut `Random.nextDouble()`) afin de rendre la
 * politique déterministe et donc testable. Source aléatoire multiplateforme (kotlin.random),
 * pas `Math.random()` qui est JVM-only.
 *
