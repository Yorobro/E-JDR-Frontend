...
sealed class FriendGroupError(override val message: String) : DomainError {
    ...
    data object InvitationAlreadyPending : FriendGroupError("Une invitation est déjà en attente pour cet utilisateur.")
    ...
    data object CannotRemoveAdmin : FriendGroupError("Un administrateur ne peut pas retirer un autre administrateur.")
