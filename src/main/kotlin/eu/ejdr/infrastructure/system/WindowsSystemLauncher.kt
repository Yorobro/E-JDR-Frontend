...
/**
 * Implémentation Windows de [SystemLauncher].
 *
 ...
 * l'infrastructure : la couche application ne dépend que du port [SystemLauncher].
 */
class WindowsSystemLauncher : SystemLauncher {
