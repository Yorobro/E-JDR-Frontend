 ...
 * [eu.ejdr.domain.entities.auth.Credentials].
 *
 ...
 * vers l'entité domaine [eu.ejdr.domain.entities.auth.User] par [AuthHttpMapper].
 ...
 * pour produire une [eu.ejdr.domain.error.entities.auth.AuthError] du domaine.
