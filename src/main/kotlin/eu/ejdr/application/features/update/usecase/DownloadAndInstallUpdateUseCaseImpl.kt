 ...
 * le lancement et la fermeture de l'application au port [SystemLauncher]. Les effets
 * de bord OS (processus externe, exit JVM) sont ainsi tenus hors de la couche
